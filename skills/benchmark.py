...
Examples:
    python skills/benchmark.py test_kernels/14_Gemm_Divide_Sum_Scaling_pytorch.py output/14_Gemm_Divide_Sum_Scaling_triton.py
    python skills/benchmark.py test_kernels/14_Gemm_Divide_Sum_Scaling_triton.py output/14_optimized_triton.py --triton-baseline
    python skills/benchmark.py baseline.py triton.py --baseline-us 123.45  # skip baseline perf, use cached value
"""
